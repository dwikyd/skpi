...
<div class="card border-light shadow-sm mb-4">
	<div class="card-header">
		<h3><span class="fas fa-archive"></span> Reviewer SKPI</h3>
	</div>
	<div class="card-body">
		<div>
		...
		<div class="table-responsive py-4">
			<table class="table table-hover" id="data">
				<thead class="thead-light">
					<tr><th width="30px">No</th><th>Nama Reviewer</th><th width="30px">Jenis</th><th width="30px">Aktif</th><th width="30px">Aksi</th></tr>
				</thead>
				<tbody>
				</tbody>
			</table>
		...
		<div class="modal-content">
			<div class="modal-body p-0">
				<div class="card border-light p-4">
					<div class="card-header">
						<h2 class="mb-0 h4"><span class="fas fa-language"></span> Reviewer SKPI</h2>
					</div>
					<div class="card-body">
...
<script>
	$(function () {
		$('form').on('submit', function (e) {
			...
			$.ajax({
				type: 'post',
				url: 'pages/petugas/terjemah_reviewer/proses.php',
				data: $('form').serialize(),
				success: function (a) {
					if(a==""){
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#data').DataTable( {
			...
			"deferRender": true,
			"ajax":{
				url: 'pages/petugas/terjemah_reviewer/tabel.php',
				type: "post",
				error: function(){
					$(".data-error").html("");
